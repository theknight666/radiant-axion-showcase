...
export function RoiCalculator({ onBookCall, className = "" }: RoiCalculatorProps) {
  ...
  // Average CVR lift: +85% relative (1.85x)
  // Ad spend efficiency / CAC reduction: -38%
  // 12-Month Projected Net New Revenue lift
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-[36px] bg-gradient-to-b from-[#141720] via-[#0E1015] to-[#0A0B0E] p-6 sm:p-10 lg:p-12 text-white border border-white/12 shadow-[0_35px_90px_-20px_rgba(0,0,0,0.85),inset_0_1px_1.5px_rgba(255,255,255,0.25)] ${className}`}
    >
        ...
        <div className="lg:col-span-7 space-y-7">
          ...
          <div className="space-y-2.5">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[16px] font-bold text-white bg-white/10 px-3.5 py-0.5 rounded-full border border-white/10">
          ...
          <div className="space-y-2.5">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[16px] font-bold text-[#F26522] bg-[#F26522]/15 px-3.5 py-0.5 rounded-full border border-[#F26522]/30">
                {cvr}%
              </span>
            </div>
            <input
          ...
          <div className="relative rounded-[32px] bg-white/[0.06] border border-white/15 p-6 sm:p-7 backdrop-blur-xl shadow-[0_20px_50px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.2)]">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 pt-4 border-t border-white/10">
              <div className="bg-black/30 p-3.5 rounded-[20px] border border-white/5">
                ...
                <span className="text-[10px] text-emerald-400 font-medium">+{cvrDelta}% delta</span>
              </div>
              <div className="bg-black/30 p-3.5 rounded-[20px] border border-white/5">
