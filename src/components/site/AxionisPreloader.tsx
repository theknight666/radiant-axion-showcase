      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: "38%",
            background:
              "linear-gradient(to bottom, rgba(255,255,255,0.14) 0%, rgba(255,255,255,0.04) 40%, transparent 100%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            height: "1.5px",
            background:
              "linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.0) 8%, rgba(255,255,255,0.82) 25%, rgba(255,255,255,0.95) 50%, rgba(255,255,255,0.82) 75%, rgba(255,255,255,0.0) 92%, transparent 100%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            height: "1px",
            background:
              "linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.25) 20%, rgba(255,255,255,0.38) 50%, rgba(255,255,255,0.25) 80%, transparent 100%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            width: "1px",
            background:
              "linear-gradient(180deg, rgba(255,255,255,0.0) 0%, rgba(255,255,255,0.45) 20%, rgba(255,255,255,0.18) 80%, rgba(255,255,255,0.0) 100%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            width: "1px",
            background:
              "linear-gradient(180deg, rgba(255,255,255,0.0) 0%, rgba(255,255,255,0.3) 20%, rgba(255,255,255,0.1) 80%, rgba(255,255,255,0.0) 100%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            height: "2px",
            background:
              "linear-gradient(90deg, transparent 0%, rgba(100,160,255,0.18) 30%, rgba(100,160,255,0.22) 50%, rgba(100,160,255,0.18) 70%, transparent 100%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            height: "1px",
            background:
              "linear-gradient(90deg, transparent 0%, transparent 15%, rgba(255,255,255,0.22) 30%, rgba(255,255,255,0.35) 50%, rgba(255,255,255,0.22) 70%, transparent 85%, transparent 100%)",
        ...
        <div
          ...
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse 80% 70% at 50% 0%, transparent 50%, rgba(0,0,0,0.04) 100%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div
          style={{
            ...
            animation:
              mounted && !exiting
                ? "axContentIn 0.7s cubic-bezier(0.22,1,0.36,1) forwards"
                : "none",
            ...
            >
              <p
                ...
                style={{
                  ...
                  animation: "axFadeUp 0.3s ease forwards",
                }}
              >
                {STATUS[statusIndex]}
              </p>
